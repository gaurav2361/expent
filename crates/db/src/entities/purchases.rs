...
#[ts(export, rename = "Purchase", export_to = "../../../packages/types/src/db/Purchase.ts")]
pub struct Model {
    pub id: String,
...
impl ColumnTrait for Column {
    ...
    fn def(&self) -> ColumnDef {
        match self {
            ...
            Self::OrderId => ColumnType::String(StringLen::None).def().null(),
        }
    }
}
...
impl RelationTrait for Relation {
    fn def(&self) -> RelationDef {
        match self {
            Self::PurchaseItems => Entity::has_many(super::purchase_items::Entity).into(),
