 ...
 * defined in global.css. Used by React Native Reusables components
 * that depend on the navigation theme context.
 */
export const THEME = {
  light: {
...
export const NAV_THEME = {
  light: {
    ...
    fonts: {
      ...
      heavy: { fontFamily: "Inter", fontWeight: "900" as const },
    },
  } satisfies Theme,
  dark: {
    dark: true,
