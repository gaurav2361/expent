...
import { Plus, Wallet, FileText, ArrowUpRight, ArrowDownLeft, Bell } from 'lucide-react-native';
      ...
      >
        ...
        >
          ...
          <View className="flex-row items-center gap-2 mb-3">
            ...
            <Text className="text-primary-foreground/80 font-semibold uppercase tracking-widest text-[10px]">Net Balance</Text>
          </View>
          ...
          <View className="mt-8 pt-6 border-t border-white/10 flex-row justify-between">
            <View className="gap-1">
              <Text className="text-primary-foreground/60 text-[10px] uppercase font-bold tracking-wider">Monthly Spend</Text>
              <Text 
                style={{ fontVariant: ['tabular-nums'] }}
            ...
            <View className="items-end gap-1">
              <Text className="text-primary-foreground/60 text-[10px] uppercase font-bold tracking-wider">P2P Pending</Text>
                ...
                >
                  <CardContent className="p-5 flex-row items-center justify-between">
                    <View className="flex-row items-center gap-4">
                      <View className={`w-12 h-12 rounded-2xl items-center justify-center ${item.type === 'IN' ? 'bg-success-100/50' : 'bg-danger-100/50'}`}>
                        {item.type === 'IN' ? (
        ...
        <Animated.View entering={FadeInDown.delay(800)} className="mb-24">
          ...
          <TouchableOpacity onPress={() => router.push('/(tabs)/insights')}>
            ...
            >
              ...
              <Text className="text-sm text-muted-foreground mt-1 text-center">See where your money goes every month</Text>
            </Card>
          </TouchableOpacity>
        </Animated.View>
      </ScrollView>
