      ...
      <ScrollView>
        <View className="flex-1 px-4 pt-16">
          ...
          <SettingsContainer title="Support Us">
            <SettingsItem text="Share" icon={<Share color={iconColor} />} onPress={() => {}} />
            <SettingsItem text="Rate" icon={<Rate color={iconColor} />} onPress={() => {}} />
            <SettingsItem text="Support" icon={<Support color={iconColor} />} onPress={() => {}} />
          </SettingsContainer>

          <SettingsContainer title="Links">
            <SettingsItem text="Privacy Policy" onPress={() => {}} />
            <SettingsItem text="Terms of Service" onPress={() => {}} />
            <SettingsItem text="Github" icon={<Github color={iconColor} />} onPress={() => {}} />
            <SettingsItem text="Website" icon={<Website color={iconColor} />} onPress={() => {}} />
          </SettingsContainer>
